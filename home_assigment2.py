...
class TestHomeAssignment2(unittest.TestCase):
    def setUp(self):
        self.url = "https://www.mediawiki.org/w/api.php"
        self.session = requests.Session()

    def test_find_on_page_unique_words(self):
        try:
    ...
    def test_find_page_and_exclude_delimiters(self):
        try:
            # Prepare request to query the API
            params = {
                "action": "query",
